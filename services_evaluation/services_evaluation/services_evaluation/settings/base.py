"""
Django settings for services_evaluation project.
"""
...
ADMINS = (
    ("""Aya Joumaa""", "aya.joumaait@gmail.com"),
)
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="mysql://root:root@localhost:3306/services_evaluation")
}
...
ROOT_URLCONF = "services_evaluation.urls"

# Python dotted path to the WSGI application used by Django"s runserver.
WSGI_APPLICATION = "services_evaluation.wsgi.application"
